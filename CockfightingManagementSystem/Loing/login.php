...
<body class="login-page">
    ...
    <a href="home.html" class="back-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="rgba" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    <section class="login-card reveal-scale w-full max-w-[90%] sm:max-w-[430px] md:max-w-[520px]">
        ...
        >
            ...
            <div class="text-right mb-6">
                <a href="forgot-password.php" class="text-xs font-semibold text-gray-700 hover:text-emerald-600">
                    ลืมรหัสผ่าน?
                </a>
            </div>
            ...
            <p class="text-center text-sm mt-6">
                ยังไม่มีบัญชีใช่ไหม?
                <a href="register.php" class="font-bold text-emerald-700">
                    สมัครสมาชิก
                </a>
            </p>
        </form>
