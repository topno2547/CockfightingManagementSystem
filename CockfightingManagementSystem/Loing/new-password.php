        ...
        if ($u_password !== $confirm_password) {
            ...
            if (empty($conditions)) {
                ...
                if ($stmt->execute() && $stmt->affected_rows >= 0) {
                    ...
                    new_password_response(true, "เปลี่ยนรหัสผ่านสำเร็จ", "login.php");
...
<body class="login-page">
    ...
    <a href="verify-otp.php" class="back-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="rgba" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15.75 3 12m0 0 3.75-3.75M3 12h18" />
    ...
    <section class="login-card reveal-scale w-full max-w-[90%] sm:max-w-[430px] md:max-w-[520px]">
        ...
        <form
            id="login-form"
            method="POST"
            action="new-password.php" data-success-redirect="login.php"
        >
